...
public abstract class DashSwing implements IDashSwing {
	...
	protected void locateFrame() {
		...
		Point location = new Point((screenSize.width - this.frame.getSize().width) / 2,
	 ...
	 *            The component
	 */
	public void addComponent(Component component, int rowIdx, int colIdx, int rowCount, int colCount,
