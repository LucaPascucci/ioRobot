...
public class CtrlDashSwingImpl extends DashSwing {
	...
	protected CtrlDashSwingImpl(final String name, final IGaugeDisplaySwingImpl gaugeDisplay) {

		super(name);
		this.addComponent(gaugeDisplay.getMainPanel(), 0, 0, 1, 1, 4.0, 4.0);
		// if( cmdDisplay!=null ) this.addComponent(cmdDisplay.getMainPanel(),
		// 1, 0, 1, 1, 1.0, 1.0);
	...
	public static CtrlDashSwingImpl create(final String name, final IGaugeDisplaySwingImpl gaugeDisplay) {
		System.out.println("%%% CtrlDashSwingImpl");
	...
	// CmdDisplaySwingImpl.create("CmdDisplay");
