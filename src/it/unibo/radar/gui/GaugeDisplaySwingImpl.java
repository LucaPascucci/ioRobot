...
public class GaugeDisplaySwingImpl implements IGaugeDisplaySwingImpl {
	...
	public GaugeDisplaySwingImpl(final String name, final IGaugeViewSwingImpl tachometerView) {
	...
	public static GaugeDisplaySwingImpl create(final String name, final IGaugeViewSwingImpl tachometerView) {
	...
	protected void setupGaugesPanel() {
		...
		this.addComponent(this.getGaugesPanel(), this.tachometerView.getMainPanel(), 1, 0, 2, 3, 1.0, 0.1);
	}
	 ...
	 *            The component row
	 */
	protected void addComponent(Container container, Component component, int rowIdx, int colIdx, int rowCount,
			int colCount, double horizontalWeight, double verticalWeight) {
		Insets insets = new Insets(0, 0, 0, 0);
		GridBagConstraints gbc = new GridBagConstraints(colIdx, rowIdx, colCount, rowCount, horizontalWeight,
				verticalWeight, GridBagConstraints.NORTH, GridBagConstraints.BOTH, insets, 0, 0);
