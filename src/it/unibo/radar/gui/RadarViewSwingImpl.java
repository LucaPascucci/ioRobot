...
import it.unibo.radargui.SonarRadarKb;
...
public class RadarViewSwingImpl extends GaugeViewSwingImpl implements IRadarViewSwingImpl {
	...
	private Poi MY_LOCATION = new Poi("P0", mylat, mylon); // LAT, LON
															// 44.5,11.34 89 ALT
	...
	/*
	 * 0.00001 d = 0.7942856891525684 0.0001 d = 7.9292288742391355 0.001 d =
	 * 79.28921974457752 0.01 d = 792.8923798224253 0.015 d = 1189.3385706930774
	 * 0.035 d = 2775.1233267929597 0.02 d = 1585.7847627150563 0.1 d =
	 * 7928.923356810496
	 */
	...
	public void update(final String value) {
		// delay(1000);
		// System.out.println(" *** RadarViewSwingImpl updating ... " + value +
		// " nn=" + nn);
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				// addNewTargetByMoving("PT"+nn, distance * 1000, arg);
				// //VERSION WITH POINT NAME
	...
	protected void addNewTargetByMoving(String name, double dist, double angle) {
		...
		// System.out.println(" +++ " + name +" loc=" + pref.getLocation() + "
		// DISTANCE=" + dp );
	}
