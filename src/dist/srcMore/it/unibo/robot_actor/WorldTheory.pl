%==============================================
% WorldTheory.pl for actor robot_actor
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobot_actor).	%%old version (deprecated)
actorobj(qaturobot_actor).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robot_actor
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robot_actor" ). 
